...
public class MainActivity extends ListActivity
{
   ...
   private RadioButton radioSearchTypeButton;
   ...
   OnItemClickListener itemClickListener = new OnItemClickListener() 
   {
         ...
         int position, long id) 
      {
    	// get query string and create a URL representing the search
    	  ...
    	  String filter = "";
    	  int selectedButton = radioSearchType.getCheckedRadioButtonId();
    	  radioSearchTypeButton = (RadioButton) findViewById(selectedButton);
    	  if (!radioSearchTypeButton.getText().toString().equalsIgnoreCase("none")) {
    	  filter = " filter:" + radioSearchTypeButton.getText().toString().toLowerCase();
    	  }
    	  String urlString = getString(R.string.searchURL) + Uri.encode(savedSearches.getString(tag, "") + Uri.decode(filter), "UTF-8");
